  ...
  return (
    <div className="p-2 flex flex-col h-screen">
      <div className="flex-1 ">
        <div className="">
          <h2 className="text-white animate-pulse text-center p-2 my-3 text-sm  font-semibold bg-cyan-900 chatRow">Only messages are supported.</h2>
          {/* New Chat */}
          <NewChat />
      ...
      {session && (
        <div className="flex items-center space-y-4 justify-around">
          <div className="hidden md:flex md:flex-col md:justify-center md:items-center md:bg-slate-800 md:py-4 md:flex-1 md:mr-12 md:rounded-lg">
            ...
            <h3 className="text-xs text-center uppercase text-white font-bold pt-2">{session.user?.name!}</h3>
          </div>
